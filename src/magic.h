...
DECLARE_SPELL_FUN(	spell_rot_object	);
DECLARE_SPELL_FUN(	spell_remove_rot	);
DECLARE_SPELL_FUN(	spell_remove_invis	);
DECLARE_SPELL_FUN(	spell_charisma		);
DECLARE_SPELL_FUN(	spell_shrink		);
DECLARE_SPELL_FUN(      spell_create_sign	);
...
DECLARE_SPELL_FUN(	spell_eternal_light	);
...
DECLARE_SPELL_FUN(      spell_light_feet  );
...
DECLARE_SPELL_FUN(      spell_nuclear_blast );
...
DECLARE_SPELL_FUN(	spell_flamewall		);
